...
**Tagline:** "Your AI tried. Veto said no."
...
- `agent/` — Python autonomous trading agent
...
| **AI Agent** | Python 3.12, web3.py |
| **Dashboard** | Next.js, Tailwind CSS, TypeScript |
